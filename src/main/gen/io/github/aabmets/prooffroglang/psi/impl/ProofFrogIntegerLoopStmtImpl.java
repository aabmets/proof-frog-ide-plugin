...
public class ProofFrogIntegerLoopStmtImpl extends ASTWrapperPsiElement implements ProofFrogIntegerLoopStmt {

  public ProofFrogIntegerLoopStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitIntegerLoopStmt(this);
  }
