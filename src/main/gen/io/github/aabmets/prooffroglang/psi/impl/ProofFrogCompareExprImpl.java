...
public class ProofFrogCompareExprImpl extends ASTWrapperPsiElement implements ProofFrogCompareExpr {

  public ProofFrogCompareExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogAddExpr> getAddExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogAddExpr.class);
  }
