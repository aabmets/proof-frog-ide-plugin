...
public class ProofFrogComparisonExpressionImpl extends ASTWrapperPsiElement implements ProofFrogComparisonExpression {

  public ProofFrogComparisonExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogAddExpression> getAddExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogAddExpression.class);
  }
