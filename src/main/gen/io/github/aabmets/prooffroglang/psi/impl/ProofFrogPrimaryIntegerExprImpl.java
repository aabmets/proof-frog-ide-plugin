...
public class ProofFrogPrimaryIntegerExprImpl extends ASTWrapperPsiElement implements ProofFrogPrimaryIntegerExpr {

  public ProofFrogPrimaryIntegerExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitPrimaryIntegerExpr(this);
  }
