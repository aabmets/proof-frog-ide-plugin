...
public class ProofFrogCallExpressionImpl extends ASTWrapperPsiElement implements ProofFrogCallExpression {

  public ProofFrogCallExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
