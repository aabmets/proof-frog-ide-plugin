...
public class ProofFrogIntegerExprImpl extends ASTWrapperPsiElement implements ProofFrogIntegerExpr {

  public ProofFrogIntegerExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ProofFrogAddIntegerExpr getAddIntegerExpr() {
    return findNotNullChildByClass(ProofFrogAddIntegerExpr.class);
  }
