...
public class ProofFrogPrimaryElementImpl extends ASTWrapperPsiElement implements ProofFrogPrimaryElement {

  public ProofFrogPrimaryElementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitPrimaryElement(this);
  }
