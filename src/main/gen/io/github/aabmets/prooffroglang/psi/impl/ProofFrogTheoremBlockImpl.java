...
public class ProofFrogTheoremBlockImpl extends ASTWrapperPsiElement implements ProofFrogTheoremBlock {

  public ProofFrogTheoremBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitTheoremBlock(this);
  }
