...
public class ProofFrogParamListImpl extends ASTWrapperPsiElement implements ProofFrogParamList {

  public ProofFrogParamListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogVariable> getVariableList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogVariable.class);
  }
