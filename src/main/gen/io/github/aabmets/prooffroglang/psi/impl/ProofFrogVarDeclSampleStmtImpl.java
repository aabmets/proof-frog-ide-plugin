...
public class ProofFrogVarDeclSampleStmtImpl extends ASTWrapperPsiElement implements ProofFrogVarDeclSampleStmt {

  public ProofFrogVarDeclSampleStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitVarDeclSampleStmt(this);
  }
