...
public class ProofFrogVarDeclAssignStmtImpl extends ASTWrapperPsiElement implements ProofFrogVarDeclAssignStmt {

  public ProofFrogVarDeclAssignStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitVarDeclAssignStmt(this);
  }
  ...
  public ProofFrogLvalue getLvalue() {
    return findNotNullChildByClass(ProofFrogLvalue.class);
  }

  @Override
  @NotNull
  public ProofFrogType getType() {
    return findNotNullChildByClass(ProofFrogType.class);
  }
