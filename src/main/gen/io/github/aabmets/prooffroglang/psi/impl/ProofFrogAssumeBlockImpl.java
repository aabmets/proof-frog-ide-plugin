...
public class ProofFrogAssumeBlockImpl extends ASTWrapperPsiElement implements ProofFrogAssumeBlock {

  public ProofFrogAssumeBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitAssumeBlock(this);
  }
  ...
  public ProofFrogAssumptions getAssumptions() {
    return findNotNullChildByClass(ProofFrogAssumptions.class);
  }
