...
public class ProofFrogBlockImpl extends ASTWrapperPsiElement implements ProofFrogBlock {

  public ProofFrogBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogStatement> getStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogStatement.class);
  }
