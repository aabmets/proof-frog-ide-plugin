...
public class ProofFrogAssumptionsImpl extends ASTWrapperPsiElement implements ProofFrogAssumptions {

  public ProofFrogAssumptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitAssumptions(this);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogParameterizedGame> getParameterizedGameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogParameterizedGame.class);
  }
