...
public class ProofFrogOrExprImpl extends ASTWrapperPsiElement implements ProofFrogOrExpr {

  public ProofFrogOrExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogAndExpr> getAndExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogAndExpr.class);
  }
