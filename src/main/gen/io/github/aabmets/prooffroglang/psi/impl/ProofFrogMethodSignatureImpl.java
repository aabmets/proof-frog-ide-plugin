...
public class ProofFrogMethodSignatureImpl extends ASTWrapperPsiElement implements ProofFrogMethodSignature {

  public ProofFrogMethodSignatureImpl(@NotNull ASTNode node) {
    super(node);
  }
