...
public class ProofFrogMultiplyExprImpl extends ASTWrapperPsiElement implements ProofFrogMultiplyExpr {

  public ProofFrogMultiplyExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogUnaryExpr> getUnaryExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogUnaryExpr.class);
  }
