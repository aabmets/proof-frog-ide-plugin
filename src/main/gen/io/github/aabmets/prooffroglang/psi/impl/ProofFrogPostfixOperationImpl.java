...
public class ProofFrogPostfixOperationImpl extends ASTWrapperPsiElement implements ProofFrogPostfixOperation {

  public ProofFrogPostfixOperationImpl(@NotNull ASTNode node) {
    super(node);
  }
