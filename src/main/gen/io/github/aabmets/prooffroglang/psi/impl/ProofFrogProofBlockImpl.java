...
public class ProofFrogProofBlockImpl extends ASTWrapperPsiElement implements ProofFrogProofBlock {

  public ProofFrogProofBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitProofBlock(this);
  }
