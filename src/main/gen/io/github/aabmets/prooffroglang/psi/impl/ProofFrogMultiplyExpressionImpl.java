...
public class ProofFrogMultiplyExpressionImpl extends ASTWrapperPsiElement implements ProofFrogMultiplyExpression {

  public ProofFrogMultiplyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogUnaryExpression> getUnaryExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogUnaryExpression.class);
  }
