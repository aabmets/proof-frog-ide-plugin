...
public class ProofFrogGamesBlockImpl extends ASTWrapperPsiElement implements ProofFrogGamesBlock {

  public ProofFrogGamesBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitGamesBlock(this);
  }
