...
public class ProofFrogGenericLoopStmtImpl extends ASTWrapperPsiElement implements ProofFrogGenericLoopStmt {

  public ProofFrogGenericLoopStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitGenericLoopStmt(this);
  }
