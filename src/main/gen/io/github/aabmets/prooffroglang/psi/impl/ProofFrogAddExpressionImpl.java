...
public class ProofFrogAddExpressionImpl extends ASTWrapperPsiElement implements ProofFrogAddExpression {

  public ProofFrogAddExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogMultiplyExpression> getMultiplyExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogMultiplyExpression.class);
  }
