...
public class ProofFrogLetsImpl extends ASTWrapperPsiElement implements ProofFrogLets {

  public ProofFrogLetsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitLets(this);
  }
