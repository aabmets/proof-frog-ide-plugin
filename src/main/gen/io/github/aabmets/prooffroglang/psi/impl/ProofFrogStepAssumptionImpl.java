...
public class ProofFrogStepAssumptionImpl extends ASTWrapperPsiElement implements ProofFrogStepAssumption {

  public ProofFrogStepAssumptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitStepAssumption(this);
  }
