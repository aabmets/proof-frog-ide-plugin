...
public class ProofFrogProofProgramImpl extends ASTWrapperPsiElement implements ProofFrogProofProgram {

  public ProofFrogProofProgramImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitProofProgram(this);
  }
  ...
  @Override
  @NotNull
  public ProofFrogProof getProof() {
    return findNotNullChildByClass(ProofFrogProof.class);
  }
