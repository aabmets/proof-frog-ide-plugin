...
public class ProofFrogUnionExprImpl extends ASTWrapperPsiElement implements ProofFrogUnionExpr {

  public ProofFrogUnionExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogOrExpr> getOrExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogOrExpr.class);
  }
