...
public class ProofFrogLetsBlockImpl extends ASTWrapperPsiElement implements ProofFrogLetsBlock {

  public ProofFrogLetsBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitLetsBlock(this);
  }
  ...
  public ProofFrogLets getLets() {
    return findNotNullChildByClass(ProofFrogLets.class);
  }
