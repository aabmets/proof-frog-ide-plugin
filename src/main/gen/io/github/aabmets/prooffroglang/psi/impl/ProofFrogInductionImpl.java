...
public class ProofFrogInductionImpl extends ASTWrapperPsiElement implements ProofFrogInduction {

  public ProofFrogInductionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitInduction(this);
  }
