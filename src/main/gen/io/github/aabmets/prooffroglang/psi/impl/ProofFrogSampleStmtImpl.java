...
public class ProofFrogSampleStmtImpl extends ASTWrapperPsiElement implements ProofFrogSampleStmt {

  public ProofFrogSampleStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitSampleStmt(this);
  }
