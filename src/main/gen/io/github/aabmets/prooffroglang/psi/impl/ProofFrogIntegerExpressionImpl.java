...
public class ProofFrogIntegerExpressionImpl extends ASTWrapperPsiElement implements ProofFrogIntegerExpression {

  public ProofFrogIntegerExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ProofFrogAdditiveIntegerExpression getAdditiveIntegerExpression() {
    return findNotNullChildByClass(ProofFrogAdditiveIntegerExpression.class);
  }
