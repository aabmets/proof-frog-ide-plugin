...
public class ProofFrogVarDeclStmtImpl extends ASTWrapperPsiElement implements ProofFrogVarDeclStmt {

  public ProofFrogVarDeclStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
