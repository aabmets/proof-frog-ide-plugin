...
public class ProofFrogUnionExpressionImpl extends ASTWrapperPsiElement implements ProofFrogUnionExpression {

  public ProofFrogUnionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogOrExpression> getOrExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogOrExpression.class);
  }
