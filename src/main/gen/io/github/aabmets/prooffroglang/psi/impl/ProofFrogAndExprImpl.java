...
public class ProofFrogAndExprImpl extends ASTWrapperPsiElement implements ProofFrogAndExpr {

  public ProofFrogAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogCompareExpr> getCompareExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogCompareExpr.class);
  }
