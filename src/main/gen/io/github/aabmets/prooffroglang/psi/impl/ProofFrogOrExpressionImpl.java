...
public class ProofFrogOrExpressionImpl extends ASTWrapperPsiElement implements ProofFrogOrExpression {

  public ProofFrogOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogAndExpression> getAndExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogAndExpression.class);
  }
