...
public class ProofFrogPrimaryIntegerExpressionImpl extends ASTWrapperPsiElement implements ProofFrogPrimaryIntegerExpression {

  public ProofFrogPrimaryIntegerExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitPrimaryIntegerExpression(this);
  }
