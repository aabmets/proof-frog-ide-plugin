...
public class ProofFrogGamePhaseImpl extends ASTWrapperPsiElement implements ProofFrogGamePhase {

  public ProofFrogGamePhaseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitGamePhase(this);
  }
