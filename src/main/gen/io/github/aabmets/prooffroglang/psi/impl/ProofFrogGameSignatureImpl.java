...
public class ProofFrogGameSignatureImpl extends ASTWrapperPsiElement implements ProofFrogGameSignature {

  public ProofFrogGameSignatureImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitGameSignature(this);
  }
