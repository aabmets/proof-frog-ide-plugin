...
public class ProofFrogAddExprImpl extends ASTWrapperPsiElement implements ProofFrogAddExpr {

  public ProofFrogAddExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ProofFrogMultiplyExpr> getMultiplyExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ProofFrogMultiplyExpr.class);
  }
