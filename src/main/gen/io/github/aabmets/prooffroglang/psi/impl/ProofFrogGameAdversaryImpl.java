...
public class ProofFrogGameAdversaryImpl extends ASTWrapperPsiElement implements ProofFrogGameAdversary {

  public ProofFrogGameAdversaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ProofFrogVisitor visitor) {
    visitor.visitGameAdversary(this);
  }
